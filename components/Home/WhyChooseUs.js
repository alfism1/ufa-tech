    ...
    <section className="choose-ue-area ptb-100">
      <div className="container">
        <div className="section-title">
          ...
          <h2>{whyChooseUsData.nameWhyChooseUse}</h2>
          <p>{whyChooseUsData.contentWhyChooseUs}</p>
        </div>
        ...
        <div className="row align-items-center">
          <div className="col-lg-6">
            <div className="choose-content">
              <ul>
                {whyChooseUsData.refWhyChooseUsPoint
                  .slice(0, 2)
                  .map((data, i) => (
                    <li key={data.id} className={i == 1 ? "ml" : ""}>
                      <span>
                        {data.orderBy} <i className="flaticon-shield"></i>
                      </span>
                      <h3>{data.nameWhyChooseUsePoint}</h3>
                      <p>{data.descWhyChooseUs}</p>
                    </li>
                  ))}
                {/* <li>
                  <span>
                  ...
                  <h3>Keamanan</h3>
                  <p>
                    Sistem yang kami buat sangat memperhatikan keamanan,
                    sehingga prosentase kerugian yang dihasilkan sangat minimal.
                  </p>
                </li>
                <li className="ml">
                  <span>
                  ...
                  <p>
                    Kami akan dengan senang hati membantu saat terjadi kendala
            ...
            <div className="choose-content">
              <ul>
                ...
                {/* <li className="ml-25">
                  ...
                  <p>
                    Harga yang kami tawarkan sangat terjangkau, sehingga anda
                    bisa mendapatkan layanan hebat dengan harga bersahabat.
                  </p>
                </li>
                <li>
                  <span>
                  ...
                  <p>
                    Perkembangan dunia IT sangatlah cepat, dan kami selalu
                    beradaptasi untuk memberikan hasil yang terbaik.
                  </p>
                </li> */}
              </ul>
            </div>
